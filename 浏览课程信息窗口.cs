...
{
    public partial class 浏览课程信息窗口 : Form
    {
        private 添加课程信息窗口 FormAddN;
        private 修改课程信息窗口 FormModifyN;
        private 删除课程信息窗口 FormDeleteN;
        ...
        private void 浏览课程信息窗口_Load(object sender, EventArgs e)
        {
            string connectionString = Session.connstr;
            m_connection = new SqlConnection(connectionString);
            m_connection.Open();
            stuText = "select * from 课程";
        ...
        {
            FormModifyN = new 修改课程信息窗口();

            FormModifyN.C_Num = dataGridView1.Rows[indexS].Cells[0].Value.ToString();
            FormModifyN.C_Name = dataGridView1.Rows[indexS].Cells[1].Value.ToString();
            FormModifyN.C_Cre = dataGridView1.Rows[indexS].Cells[2].Value.ToString();
        ...
        {
            FormDeleteN = new 删除课程信息窗口();
            FormDeleteN.C_Num = dataGridView1.Rows[indexS].Cells[0].Value.ToString();
